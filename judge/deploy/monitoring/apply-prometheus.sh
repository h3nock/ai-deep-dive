...
ALERT_WORKER_HEARTBEAT_STALE_SECONDS=${ALERT_WORKER_HEARTBEAT_STALE_SECONDS:-90}
...
require_positive_number "ALERT_WORKER_HEARTBEAT_STALE_SECONDS" "$ALERT_WORKER_HEARTBEAT_STALE_SECONDS"
...
awk \
  ...
  -v worker_heartbeat_stale_seconds="$ALERT_WORKER_HEARTBEAT_STALE_SECONDS" \
  ...
  '
  {
    ...
    gsub("__WORKER_HEARTBEAT_STALE_SECONDS__", worker_heartbeat_stale_seconds)
