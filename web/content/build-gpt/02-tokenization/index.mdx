...
<Step title="2. The Algorithm: A Visual Walkthrough">
  ...
  <h4 className="text-lg font-semibold text-primary" style={{ marginTop: 'var(--space-flow)', marginBottom: 'var(--space-atomic)' }}>Iteration 0: The Starting Point</h4>
  ...
  <h4 className="text-lg font-semibold text-primary" style={{ marginTop: 'var(--space-flow)', marginBottom: 'var(--space-atomic)' }}>Step 2: The First Merge</h4>
  ...
  <h4 className="text-lg font-semibold text-primary" style={{ marginTop: 'var(--space-flow)', marginBottom: 'var(--space-atomic)' }}>Step 3: Repeat</h4>
  ...
  <h4 className="text-lg font-semibold text-primary" style={{ marginTop: 'var(--space-flow)', marginBottom: 'var(--space-atomic)' }}>The Result</h4>
...
<Step title="3. Implementing BPE in Python">
  ...
  <ProcessTimeline steps={[
    ...
    {
      title: "train_bpe",
      description: "The main loop that calls the above until we reach target vocab size"
    }
  ]} />
  ...
  <h4 className="text-lg font-semibold text-primary" style={{ marginTop: 'var(--space-flow)', marginBottom: 'var(--space-atomic)' }}>Function 1: Count Pair Statistics</h4>
...
```
  ...
  <h4 className="text-lg font-semibold text-primary" style={{ marginTop: 'var(--space-flow)', marginBottom: 'var(--space-atomic)' }}>Function 2: Merge a Pair</h4>
...
```
  ...
  <h4 className="text-lg font-semibold text-primary" style={{ marginTop: 'var(--space-flow)', marginBottom: 'var(--space-atomic)' }}>Function 3: The Training Loop</h4>
...
<Step title="4. Regex Pre-splitting">
  ...
  <h4 className="text-lg font-semibold text-primary" style={{ marginTop: 'var(--space-flow)', marginBottom: 'var(--space-atomic)' }}>The Fix: Regex Splitting</h4>
...
<Step title="5. Encoding & Decoding">
  ...
  <h4 className="text-lg font-semibold text-primary" style={{ marginTop: 'var(--space-flow)', marginBottom: 'var(--space-atomic)' }}>The Vocabulary Table</h4>
...
```
  ...
  <h4 className="text-lg font-semibold text-primary" style={{ marginTop: 'var(--space-flow)', marginBottom: 'var(--space-atomic)' }}>Visual Example: Decoding</h4>
...
```
  ...
  <h4 className="text-lg font-semibold text-primary" style={{ marginTop: 'var(--space-flow)', marginBottom: 'var(--space-atomic)' }}>Visual Example: Encoding</h4>

  <div className="my-6">
    <div className="text-xs font-medium text-muted uppercase tracking-wider mb-2">Encoding "aaab" with merges: (97,97)→256, (256,97)→257</div>
    <div className="p-4 bg-[#121212] rounded-lg border border-zinc-800">
    <div className="space-y-3 font-mono text-sm">
      <div className="flex items-center gap-3">
...
<Step title="6. The Complete Pipeline">
  ...
  <ProcessTimeline steps={[
    ...
    },
    {
      title: "Regex Split",
      data: '["Hello", " World"]',
      description: "Pre-split into meaningful chunks."
    },
    {
      title: "UTF-8 Encoding",
      data: "[72, 101, 108, 108, 111], [32, 87, 111, 114, 108, 100]",
      description: "Convert text to raw bytes."
    },
    {
      title: "BPE Merging",
    ...
    },
    {
      title: "Token IDs",
      data: "[15496, 995]",
      description: "This is what the neural network actually sees."
    }
  ]} />
