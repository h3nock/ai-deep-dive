        ...
        <div className="space-y-4">
          ...
          <div className="pb-3 border-b border-border">
            ...
            <div className="font-mono text-sm text-secondary">
              [116, 104, 101] <span className="text-muted">→</span> [<span className="text-success font-bold">256</span>, 101] <span className="text-muted text-xs">th, e</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="font-mono text-sm text-secondary">
              [256, 101] <span className="text-muted">→</span> [<span className="text-success font-bold">257</span>] <span className="text-muted text-xs">the</span>
            </div>
          </div>
        </div>
      ...
      <div className="p-4 bg-background rounded-lg border border-error/20">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="font-mono text-sm text-secondary">
              [116, 104, 101] <span className="text-muted">→</span> [<span className="text-error font-bold">256</span>, 101] <span className="text-muted text-xs">th, e</span>
            </div>
          </div>
        </div>
