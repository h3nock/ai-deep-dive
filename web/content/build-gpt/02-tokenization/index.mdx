...
<Description noMargin>
  In the previous chapter, we saw that raw bytes create sequences that are too long, and word-level tokenization creates vocabularies that are too large. The solution is **subword tokenization**. Instead of using full words or raw bytes, we chunk text into efficient pieces that balance sequence length with vocabulary size.
</Description>

<Description noMargin>
  The industry-standard algorithm for this is **Byte Pair Encoding (BPE)**. In this chapter, we'll see how it works and build it from scratch.
</Description>
</div>
...
<Step title="1. The Key Insight">
  ...
  <Description>
    Think about how you text. You don't type "Laughing Out Loud" every time. That's 17 characters. Instead, you type "LOL" (3 characters). You compressed a common phrase into a short symbol, and everyone knows what it means.
  </Description>
  ...
  <div className="my-6">
    <div className="text-xs font-medium text-subtle uppercase tracking-wider mb-2">Common Patterns Learned</div>
    <div className="bg-terminal rounded-lg border border-border divide-y divide-border">
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <span className="text-sm text-subtle ml-auto">appears constantly together</span>
      </div>
      <div className="flex items-center gap-3 px-4 py-3">
        <span className="font-mono text-secondary">th + e</span>
        <span className="text-muted">→</span>
        <span className="font-mono font-bold text-primary">the</span>
        <span className="text-sm text-subtle ml-auto">one of the most common words</span>
      </div>
      <div className="flex items-center gap-3 px-4 py-3">
        <span className="font-mono text-secondary">in + g</span>
        <span className="text-muted">→</span>
        <span className="font-mono font-bold text-primary">ing</span>
        <span className="text-sm text-subtle ml-auto">common suffix</span>
      </div>
    </div>
  </div>

  <Description>
    By the end of this process, common words like "apple" become single tokens, while rare words are split into multiple smaller tokens. The model gets to work with shorter sequences and spend its capacity on meaning instead of low-level details.
  </Description>
</Step>
...
<Step title="2. BPE Walkthrough">
  <Description>
    To understand BPE, we need to run the algorithm by hand. We'll use a short sequence to see the mechanics clearly.
  </Description>
  ...
  <div className="content-attached">
    <div className="text-xs font-medium text-subtle uppercase tracking-wider mb-2">Adjacent pairs in our sequence (same color = same pair type)</div>
    ...
    <div className="flex flex-wrap gap-x-1 gap-y-4 font-mono text-lg">
      ...
      <div className="flex items-end">
        <span className="px-2 py-1 bg-accent-1/15 rounded-t border-b-2 border-accent-1">a</span>
        <span className="px-2 py-1 bg-accent-1/15 rounded-t border-b-2 border-accent-1">a</span>
      </div>
      {/* (a,a) - amber */}
      <div className="flex items-end">
      ...
      {/* (a,b) - blue */}
      <div className="flex items-end">
        <span className="px-2 py-1 bg-accent-2/15 rounded-t border-b-2 border-accent-2">a</span>
        <span className="px-2 py-1 bg-accent-2/15 rounded-t border-b-2 border-accent-2">b</span>
      </div>
      {/* (b,d) - red */}
      <div className="flex items-end">
        <span className="px-2 py-1 bg-accent-3/15 rounded-t border-b-2 border-accent-3">b</span>
        <span className="px-2 py-1 bg-accent-3/15 rounded-t border-b-2 border-accent-3">d</span>
      </div>
      {/* (d,a) - emerald */}
      <div className="flex items-end">
        <span className="px-2 py-1 bg-accent-4/15 rounded-t border-b-2 border-accent-4">d</span>
        <span className="px-2 py-1 bg-accent-4/15 rounded-t border-b-2 border-accent-4">a</span>
      </div>
      {/* (a,a) - amber */}
      <div className="flex items-end">
        <span className="px-2 py-1 bg-accent-1/15 rounded-t border-b-2 border-accent-1">a</span>
      ...
      {/* (b,a) - purple */}
      <div className="flex items-end">
        <span className="px-2 py-1 bg-accent-5/15 rounded-t border-b-2 border-accent-5">b</span>
        <span className="px-2 py-1 bg-accent-5/15 rounded-t border-b-2 border-accent-5">a</span>
      </div>
      {/* (a,c) - cyan */}
      <div className="flex items-end">
        <span className="px-2 py-1 bg-accent-6/15 rounded-t border-b-2 border-accent-6">a</span>
        <span className="px-2 py-1 bg-accent-6/15 rounded-t border-b-2 border-accent-6">c</span>
      </div>
    </div>
    <div className="mt-4 flex flex-wrap gap-x-4 gap-y-2 text-sm text-secondary">
      <span className="flex items-center gap-1.5"><span className="w-3 h-0.5 bg-accent-1"></span>(a,a) × 4</span>
      <span className="flex items-center gap-1.5"><span className="w-3 h-0.5 bg-accent-2"></span>(a,b) × 2</span>
      <span className="flex items-center gap-1.5"><span className="w-3 h-0.5 bg-accent-3"></span>(b,d) × 1</span>
      <span className="flex items-center gap-1.5"><span className="w-3 h-0.5 bg-accent-4"></span>(d,a) × 1</span>
      <span className="flex items-center gap-1.5"><span className="w-3 h-0.5 bg-accent-5"></span>(b,a) × 1</span>
      <span className="flex items-center gap-1.5"><span className="w-3 h-0.5 bg-accent-6"></span>(a,c) × 1</span>
    </div>
    </div>
  </div>

  <div style={{ marginTop: "var(--space-connected)", marginBottom: "var(--space-connected)" }} className="flex flex-wrap gap-2">
    <div className="px-3 py-2 bg-accent-1/10 rounded border-2 border-accent-1 text-center">
      <div className="font-mono text-sm font-bold text-accent-1">(a,a)</div>
      <div className="text-lg font-bold text-accent-1">4</div>
    </div>
  ...
  <div className="my-6">
    <div className="text-xs font-medium text-subtle uppercase tracking-wider mb-2">After Merge #1: (a, a) → Z</div>
    <div className="p-4 bg-terminal rounded-lg border border-border">
    <div className="flex flex-wrap gap-2">
      <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-accent-1 text-on-accent font-mono font-bold">Z</div>
      <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-surface border-2 border-border font-mono font-bold text-primary">a</div>
      <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-surface border-2 border-border font-mono font-bold text-primary">b</div>
      <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-surface border-2 border-border font-mono font-bold text-primary">d</div>
      <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-accent-1 text-on-accent font-mono font-bold">Z</div>
  ...
  <div className="my-6">
    <div className="text-xs font-medium text-subtle uppercase tracking-wider mb-2">After Merge #2: (a, b) → Y</div>
    <div className="p-4 bg-terminal rounded-lg border border-border">
    <div className="flex flex-wrap gap-2">
      <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-accent-1 text-on-accent font-mono font-bold">Z</div>
      <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-accent-1/20 border-2 border-accent-1 text-accent-1 font-mono font-bold">Y</div>
      <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-surface border-2 border-border font-mono font-bold text-primary">d</div>
      <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-accent-1 text-on-accent font-mono font-bold">Z</div>
      <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-accent-1/20 border-2 border-accent-1 text-accent-1 font-mono font-bold">Y</div>
      <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-surface border-2 border-border font-mono font-bold text-primary">a</div>
  ...
  <div style={{ marginTop: "var(--space-connected)", marginBottom: "var(--space-connected)" }} className="p-5 bg-surface rounded-lg border border-border">
    <div className="grid grid-cols-3 gap-4 text-center">
      <div>
        ...
        <div className="text-sm text-subtle">tokens (start)</div>
      </div>
      ...
      <div>
        ...
        <div className="text-sm text-subtle">tokens (after 2 merges)</div>
      </div>
    </div>
...
```
  ...
  <Description>
    `train_bpe` combines everything into a training loop. We start with UTF-8 bytes (vocab size 256) and merge until we reach a target size. Large models use **50,000 to 100,000 tokens**, balancing efficiency through shorter sequences against the memory cost of a larger embedding table.
  </Description>
...
<Step title="4. Regex Pre-splitting">
  ...
  <div className="content-attached my-6">
    <div className="text-xs font-medium text-subtle uppercase tracking-wider mb-2">The Problem</div>
    <div className="p-4 bg-terminal rounded-lg border border-border">
  ...
  <div className="my-6">
    <div className="text-xs font-medium text-subtle uppercase tracking-wider mb-2">The Solution</div>
    <div className="p-4 bg-terminal rounded-lg border border-border">
...
<Step title="5. Encoding & Decoding">
  ...
  <Description attached>
    To decode tokens back into text, we need a **vocabulary table** that maps each token ID to its byte sequence. The base tokens 0 through 255 map directly to single bytes, so token 97 maps to `[97]`. Merged tokens store the combined bytes of the pair that created them. If token 256 was created by merging `a` and `t`, it maps to `[97, 116]`.
  </Description>

  <div className="content-attached">
    <div className="text-xs font-medium text-subtle uppercase tracking-wider mb-2">The Vocabulary: Token ID → Bytes</div>
    <div className="p-4 bg-terminal rounded-lg border border-border">
...
```
  ...
  <div className="my-6">
    <div className="text-xs font-medium text-subtle uppercase tracking-wider mb-2">Decoding [258, 99] back to text</div>
    <div className="p-4 bg-terminal rounded-lg border border-border">
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        <div className="text-sm text-subtle w-28">Token IDs:</div>
      ...
      <div className="flex items-center gap-3">
        <div className="text-sm text-subtle w-28">Look up bytes:</div>
        <div className="flex gap-3 items-center">
          <div className="flex flex-col items-center">
            <div className="text-xs text-subtle mb-1">vocab[258]</div>
            <div className="px-3 py-2 bg-accent-1/10 rounded font-mono text-sm border border-accent-1/30">[97, 97, 98]</div>
          </div>
          <div className="flex flex-col items-center">
            <div className="text-xs text-subtle mb-1">vocab[99]</div>
            <div className="px-3 py-2 bg-accent-1/10 rounded font-mono text-sm border border-accent-1/30">[99]</div>
          </div>
        </div>
      </div>
      <div className="flex items-center gap-3">
        <div className="text-sm text-subtle w-28">Concatenate:</div>
        <div className="px-3 py-2 bg-accent-1/10 rounded font-mono text-sm border border-accent-1/30">[97, 97, 98, 99]</div>
      </div>
      <div className="flex items-center gap-3">
        <div className="text-sm text-subtle w-28">Decode UTF-8:</div>
        <div className="px-3 py-2 bg-accent-1 text-on-accent rounded font-mono text-sm font-bold">"aabc"</div>
      </div>
    </div>
    </div>
  </div>
...
```
  ...
  <div className="my-8">
    <p className="text-sm text-secondary mb-5">
      For example, encoding "the" with merge rules <code className="font-mono text-xs bg-surface px-1.5 py-0.5 rounded">(116,104)→256</code> <span className="text-subtle text-xs">(t,h→th)</span> and <code className="font-mono text-xs bg-surface px-1.5 py-0.5 rounded">(256,101)→257</code> <span className="text-subtle text-xs">(th,e→the)</span>:
    </p>
    
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {/* Valid Path */}
      <div className="p-4 bg-background rounded-lg border border-success/20">
        ...
        <div className="space-y-4">
          ...
          <div className="pb-3 border-b border-border">
            <div className="text-xs text-subtle mb-1.5 font-medium">Step 1 · Apply merge #1: (116,104)→256</div>
            <div className="font-mono text-sm text-secondary">
              [116, 104, 101] <span className="text-muted">→</span> [<span className="text-success font-bold">256</span>, 101] <span className="text-subtle text-xs">th, e</span>
            </div>
          </div>
          
          {/* Step 2 */}
          <div>
            <div className="text-xs text-subtle mb-1.5 font-medium">Step 2 · Apply merge #2: (256,101)→257</div>
            <div className="font-mono text-sm text-secondary">
              [256, 101] <span className="text-muted">→</span> [<span className="text-success font-bold">257</span>] <span className="text-subtle text-xs">the</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-4 pt-3 border-t border-border">
          ...
          <span className="text-xs text-subtle ml-2">(1 token)</span>
        </div>
      </div>
      
      {/* Invalid Path */}
      <div className="p-4 bg-background rounded-lg border border-error/20">
        <div className="flex items-center gap-2 mb-4">
        ...
        <div className="space-y-4">
          {/* Step 1 */}
          <div className="pb-3 border-b border-border">
            <div className="text-xs text-subtle mb-1.5 font-medium">Step 1 · Apply merge #2: (256,101)→257</div>
            <div className="font-mono text-sm text-secondary">
              [116, 104, 101] <span className="text-muted">→</span> [116, 104, 101] <span className="text-subtle text-xs">(no 256 yet, skipped!)</span>
            </div>
          </div>
          
          {/* Step 2 */}
          <div>
            <div className="text-xs text-subtle mb-1.5 font-medium">Step 2 · Apply merge #1: (116,104)→256</div>
            <div className="font-mono text-sm text-secondary">
              [116, 104, 101] <span className="text-muted">→</span> [<span className="text-error font-bold">256</span>, 101] <span className="text-subtle text-xs">th, e</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-4 pt-3 border-t border-border">
          ...
          <span className="text-xs text-subtle ml-2">(2 tokens, missed a merge)</span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="my-6">
    <div className="text-xs font-medium text-subtle uppercase tracking-wider mb-2">Encoding "the" to tokens</div>
    <div className="p-4 bg-terminal rounded-lg border border-border">
    <div className="space-y-3 font-mono text-sm">
      <div className="flex items-center gap-3">
        <span className="text-subtle w-32">Start:</span>
        <span className="text-primary">[116, 104, 101]</span>
        <span className="text-subtle text-xs">t, h, e</span>
      </div>
      <div className="flex items-center gap-3">
        <span className="text-subtle w-32">Merge (116,104):</span>
        <span className="text-primary">[<span className="text-success font-bold">256</span>, 101]</span>
        <span className="text-subtle text-xs">th, e</span>
      </div>
      <div className="flex items-center gap-3">
        <span className="text-subtle w-32">Merge (256,101):</span>
        <span className="text-primary">[<span className="text-success font-bold">257</span>]</span>
        <span className="text-subtle text-xs">the</span>
      </div>
      <div className="flex items-center gap-3 pt-2 border-t border-border">
        <span className="text-subtle w-32">Result:</span>
        <span className="text-success font-bold">[257]</span>
        <span className="text-subtle text-xs">← 3 bytes compressed to 1 token</span>
      </div>
    </div>
    </div>
  </div>
