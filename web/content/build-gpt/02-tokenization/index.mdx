...
```
  ...
  <div className="my-8">
    <p className="text-sm text-secondary mb-5">
      For example, encoding "the" with merge rules <code className="font-mono text-xs bg-zinc-800 px-1.5 py-0.5 rounded">(116,104)→256</code> <span className="text-muted text-xs">(t,h→th)</span> and <code className="font-mono text-xs bg-zinc-800 px-1.5 py-0.5 rounded">(256,101)→257</code> <span className="text-muted text-xs">(th,e→the)</span>:
    </p>
