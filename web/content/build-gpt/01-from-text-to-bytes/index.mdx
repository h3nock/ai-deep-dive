...
<Step title="3. UTF-8">
  ...
  <div className="content-attached grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
    ...
    <div className="p-4 rounded-lg bg-terminal border border-border">
      ...
      <div className="text-xs text-muted mt-2">é, ñ, Ω, Д</div>
    ...
    <div className="p-4 rounded-lg bg-terminal border border-border">
      ...
      <div className="text-xs text-muted mt-2">中, 日, ㄱ, ሀ</div>
    ...
    <div className="p-4 rounded-lg bg-terminal border border-border">
      ...
      <div className="text-xs text-muted mt-2">😊, 🚀, 𓀀</div>
  ...
  <div style={{ marginTop: "var(--space-flow)", marginBottom: "var(--space-flow)" }}>
    ...
    <div className="font-mono text-xs bg-terminal p-4 rounded-lg border border-border overflow-x-auto">
      <div className="text-muted mb-2">Byte stream for "Aé中":</div>
    ...
    <div className="space-y-4">
      ...
      <div className="pl-4 border-l-2 border-border-hover">
        <div className="text-secondary mb-1">
          ...
          <span className="text-muted text-xs ml-3">← starts with 0 → single byte</span>
        </div>
      ...
      <div className="pl-4 border-l-2 border-border-hover">
        <div className="space-y-1 mb-1">
          <div className="text-secondary">
            ...
            <span className="text-muted text-xs ml-3">← <span className="text-accent-1">two</span> 1s → read 2 bytes</span>
          </div>
          <div className="text-secondary">
            <span className="font-semibold">A9</span>
            <span className="mx-2">=</span>
            <span className="text-muted">10</span>101001
            <span className="text-muted text-xs ml-3">← continuation</span>
          </div>
        </div>
        <div className="flex items-center gap-2 text-xs text-muted">
          <span>→</span>
      ...
      <div className="pl-4 border-l-2 border-border-hover">
        <div className="space-y-1 mb-1">
          <div className="text-secondary">
            ...
            <span className="text-muted text-xs ml-3">← <span className="text-accent-1">three</span> 1s → read 3 bytes</span>
          </div>
          <div className="text-secondary">
  ...
  <div className="my-6 space-y-4">
    ...
    <div>
      ...
      <div className="font-mono text-sm bg-terminal p-4 rounded-lg border border-border space-y-1">
        <div className="text-muted">Byte 1: <span className="text-accent-1">110</span>xxxxx → 5 data slots</div>
        <div className="text-muted">Byte 2: <span className="text-accent-1">10</span>xxxxxx → 6 data slots</div>
    ...
    <div>
      ...
      <div className="font-mono text-sm bg-terminal p-4 rounded-lg border border-border">
        <div className="text-muted">11101001 (8 bits) → <span className="text-secondary">000</span>11101001 (11 bits)</div>
      </div>
    </div>
    <div>
      ...
      <div className="bg-terminal p-4 rounded-lg border border-border">
        <ul className="space-y-3 text-sm text-secondary">
          <li className="flex justify-between items-center">
            ...
            <span className="text-xs px-2 py-1 bg-surface text-muted rounded">1-byte</span>
          </li>
          <li className="flex justify-between items-center">
          ...
          <li className="flex justify-between items-center">
            ...
            <span className="text-xs px-2 py-1 bg-surface text-muted rounded">4-byte</span>
          </li>
        </ul>
      </div>
    </div>
