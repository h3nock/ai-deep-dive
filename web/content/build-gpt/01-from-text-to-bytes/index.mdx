...
<Step title="3. UTF-8">
  ...
  <h4 className="text-lg font-semibold text-primary" style={{ marginTop: 'var(--space-flow)', marginBottom: 'var(--space-atomic)' }}>3.4 Decoding in Practice</h4>
  ...
  <h4 className="text-lg font-semibold text-primary" style={{ marginTop: 'var(--space-flow)', marginBottom: 'var(--space-atomic)' }}>3.5 Encoding in Practice</h4>
