...
<Step title="1. Text Representation">
  ...
  <div style={{ marginTop: "var(--space-flow)", marginBottom: "var(--space-flow)" }}>
    <div className="text-xs font-medium text-subtle uppercase tracking-wider mb-2">Examples of Unicode Code Point Mappings</div>
...
<Step title="3. UTF-8">
  ...
  <div className="content-attached grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
    <div className="p-4 rounded-lg bg-terminal border border-border">
      ...
      <div className="text-xs text-subtle mt-2">A-Z, a-z, 0-9</div>
    ...
    <div className="p-4 rounded-lg bg-terminal border border-border">
      ...
      <div className="text-xs text-subtle mt-2">é, ñ, Ω, Д</div>
    ...
    <div className="p-4 rounded-lg bg-terminal border border-border">
      ...
      <div className="text-xs text-subtle mt-2">中, 日, ㄱ, ሀ</div>
    ...
    <div className="p-4 rounded-lg bg-terminal border border-border">
      ...
      <div className="text-xs text-subtle mt-2">😊, 🚀, 𓀀</div>
  ...
  <div style={{ marginTop: "var(--space-flow)", marginBottom: "var(--space-flow)" }}>
    ...
    <div className="font-mono text-xs bg-terminal p-4 rounded-lg border border-border overflow-x-auto">
      <div className="text-subtle mb-2">Byte stream for "Aé中":</div>
      <div className="flex flex-wrap gap-1 mb-3">
        <span className="px-1.5 py-0.5 bg-surface rounded">00</span>
        <span className="px-1.5 py-0.5 bg-surface rounded">00</span>
        <span className="px-1.5 py-0.5 bg-surface rounded">00</span>
        <span className="px-1.5 py-0.5 bg-surface rounded">41</span>
        <span className="text-muted mx-1">|</span>
        <span className="px-1.5 py-0.5 bg-surface rounded">00</span>
        <span className="px-1.5 py-0.5 bg-surface rounded">00</span>
        <span className="px-1.5 py-0.5 bg-surface rounded">00</span>
        <span className="px-1.5 py-0.5 bg-surface rounded">E9</span>
        <span className="text-muted mx-1">|</span>
        <span className="px-1.5 py-0.5 bg-surface rounded">00</span>
        <span className="px-1.5 py-0.5 bg-surface rounded">00</span>
        <span className="px-1.5 py-0.5 bg-surface rounded">4E</span>
        <span className="px-1.5 py-0.5 bg-surface rounded">2D</span>
      </div>
      <div className="text-subtle">Every 4 bytes = 1 character.</div>
    </div>
  </div>
  ...
  <div className="content-attached">
    ...
    <div className="font-mono text-xs bg-terminal p-4 rounded-lg border border-border overflow-x-auto">
      ...
      <div className="flex flex-wrap gap-1 mb-3">
        <span className="px-1.5 py-0.5 bg-surface rounded">41</span>
        <span className="px-1.5 py-0.5 bg-surface rounded">C3</span>
        <span className="px-1.5 py-0.5 bg-surface rounded">A9</span>
        <span className="px-1.5 py-0.5 bg-surface rounded">E4</span>
        <span className="px-1.5 py-0.5 bg-surface rounded">B8</span>
        <span className="px-1.5 py-0.5 bg-surface rounded">AD</span>
      </div>
      <div className="text-subtle">6 bytes total, but which bytes belong to which character?</div>
    </div>
  </div>
    ...
    <table className="w-full text-sm border border-border rounded-lg overflow-hidden">
      ...
      <tbody className="font-mono text-xs">
        <tr className="border-t border-border">
          ...
          <td className="py-3 px-4"><span className="text-accent-1 font-semibold">0</span>xxxxxxx</td>
        ...
        <tr className="border-t border-border bg-surface">
          ...
          <td className="py-3 px-4"><span className="text-accent-1 font-semibold">110</span>xxxxx</td>
        ...
        <tr className="border-t border-border">
          ...
          <td className="py-3 px-4"><span className="text-accent-1 font-semibold">1110</span>xxxx</td>
          <td className="py-3 px-4"><span className="text-muted">10</span>xxxxxx × 2</td>
          <td className="py-3 px-4 font-sans text-secondary">16 bits</td>
        </tr>
        <tr className="border-t border-border bg-surface">
          <td className="py-3 px-4 font-sans">4 bytes</td>
          <td className="py-3 px-4"><span className="text-accent-1 font-semibold">11110</span>xxx</td>
          <td className="py-3 px-4"><span className="text-muted">10</span>xxxxxx × 3</td>
  ...
  <div className="my-6 font-mono text-sm bg-terminal p-4 rounded-lg border border-border">
    <div className="text-xs font-medium text-subtle uppercase tracking-wider mb-4">Bytes: 41 C3 A9 E4 B8 AD</div>
    ...
    <div className="space-y-4">
      ...
      <div className="pl-4 border-l-2 border-border-hover">
        <div className="text-secondary mb-1">
          ...
          <span className="text-accent-1">0</span>1000001
          <span className="text-subtle text-xs ml-3">← starts with 0 → single byte</span>
        </div>
      ...
      {/* Character 2: é (2 bytes) */}
      <div className="pl-4 border-l-2 border-border-hover">
        <div className="space-y-1 mb-1">
          <div className="text-secondary">
            <span className="font-semibold">C3</span>
            <span className="mx-2">=</span>
            <span className="text-accent-1">110</span>00011
            <span className="text-subtle text-xs ml-3">← <span className="text-accent-1">two</span> 1s → read 2 bytes</span>
          </div>
          <div className="text-secondary">
            <span className="font-semibold">A9</span>
            <span className="mx-2">=</span>
            <span className="text-muted">10</span>101001
            <span className="text-subtle text-xs ml-3">← continuation</span>
          </div>
        </div>
        <div className="flex items-center gap-2 text-xs text-subtle">
          <span>→</span>
      ...
      {/* Character 3: 中 (3 bytes) */}
      <div className="pl-4 border-l-2 border-border-hover">
        <div className="space-y-1 mb-1">
          <div className="text-secondary">
            <span className="font-semibold">E4</span>
            <span className="mx-2">=</span>
            <span className="text-accent-1">1110</span>0100
            <span className="text-subtle text-xs ml-3">← <span className="text-accent-1">three</span> 1s → read 3 bytes</span>
          </div>
          <div className="text-secondary">
            <span className="font-semibold">B8</span>
            <span className="mx-2">=</span>
            <span className="text-muted">10</span>111000
            <span className="text-subtle text-xs ml-3">← continuation</span>
          </div>
          <div className="text-secondary">
            <span className="font-semibold">AD</span>
            <span className="mx-2">=</span>
            <span className="text-muted">10</span>101101
            <span className="text-subtle text-xs ml-3">← continuation</span>
          </div>
        </div>
        <div className="flex items-center gap-2 text-xs text-subtle">
  ...
  <div className="my-6 space-y-4">
    <div>
      ...
      <div className="font-mono text-sm bg-terminal p-4 rounded-lg border border-border">
    ...
    <div>
      ...
      <div className="font-mono text-sm bg-terminal p-4 rounded-lg border border-border space-y-1">
        <div className="text-subtle">Byte 1: <span className="text-accent-1">110</span>xxxxx → 5 data slots</div>
        <div className="text-subtle">Byte 2: <span className="text-accent-1">10</span>xxxxxx → 6 data slots</div>
        <div className="text-subtle">Total: 5 + 6 = 11 data slots to fill</div>
      </div>
    </div>
    <div>
      ...
      <div className="font-mono text-sm bg-terminal p-4 rounded-lg border border-border">
        <div className="text-subtle">11101001 (8 bits) → <span className="text-secondary">000</span>11101001 (11 bits)</div>
      </div>
    </div>
    <div>
      ...
      <div className="font-mono text-sm bg-terminal p-4 rounded-lg border border-border space-y-1">
        <div className="text-subtle">Split from right: 00011 (5 bits) | 101001 (6 bits)</div>
        <div className="mt-2">Byte 1: <span className="text-accent-1">110</span> + 00011 = 11000011 = <span className="font-semibold">195 (0xC3)</span></div>
        <div>Byte 2: <span className="text-accent-1">10</span> + 101001 = 10101001 = <span className="font-semibold">169 (0xA9)</span></div>
      </div>
    </div>
    <div>
      <h5 className="text-sm font-medium text-primary mb-2">Result</h5>
      <div className="font-mono text-sm bg-terminal p-4 rounded-lg border border-border">
        "é" → <span className="font-semibold">[195 (0xC3), 169 (0xA9)]</span>
      </div>
    </div>
  </div>
</Step>
...
<Step title="4. Complete Example">
  ...
  <div className="my-6 space-y-6">
    <div>
      ...
      <div className="bg-terminal p-4 rounded-lg border border-border">
        <ul className="space-y-3 text-sm text-secondary">
          <li className="flex justify-between items-center">
            <span className="text-lg">H</span>
            <span className="font-mono text-primary">U+0048 (72)</span>
            <span className="text-xs px-2 py-1 bg-surface text-subtle rounded">1-byte</span>
          </li>
          <li className="flex justify-between items-center">
          ...
          <li className="flex justify-between items-center">
            ...
            <span className="text-xs px-2 py-1 bg-surface text-subtle rounded">4-byte</span>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div>
      ...
      <Description>
        Our four characters became seven bytes. You can verify this with <code className="text-sm">list("Hi 👋".encode('utf-8'))</code> in Python.
      </Description>
    </div>
  </div>
</Step>
...
<Step title="7. Next: Tokenization">
  ...
  <div style={{ marginTop: "var(--space-flow)", marginBottom: "var(--space-flow)" }}>
    <h5 className="text-sm font-medium text-subtle mb-3">Preview: Tokenization in action</h5>
    <div className="bg-terminal p-4 rounded-lg border border-border space-y-2 font-mono text-sm">
      <div className="flex items-center gap-2">
        <span className="text-secondary">"Hello" →</span>
        <span className="px-2 py-1 bg-surface text-primary rounded">[Hello]</span>
        <span className="text-subtle text-xs">(1 token)</span>
      </div>
      <div className="flex items-center gap-2 flex-wrap">
        <span className="text-secondary">"Unbelievable" →</span>
        <span className="px-2 py-1 bg-surface text-primary rounded">[Un]</span>
        <span className="px-2 py-1 bg-surface text-primary rounded">[believ]</span>
        <span className="px-2 py-1 bg-surface text-primary rounded">[able]</span>
        <span className="text-subtle text-xs">(3 tokens)</span>
      </div>
    </div>
  </div>
