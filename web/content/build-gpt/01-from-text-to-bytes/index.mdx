      ...
      <div className="pl-4 border-l-2 border-border-hover">
        <div className="space-y-1 mb-1">
          <div className="text-secondary">
            ...
            <span className="text-muted text-xs ml-3">← <span className="text-emerald-400">two</span> 1s → read 2 bytes</span>
          </div>
          <div className="text-secondary">
      ...
      <div className="pl-4 border-l-2 border-border-hover">
        <div className="space-y-1 mb-1">
          <div className="text-secondary">
            ...
            <span className="text-muted text-xs ml-3">← <span className="text-emerald-400">three</span> 1s → read 3 bytes</span>
          </div>
          <div className="text-secondary">
  ...
  <div className="my-6 space-y-4">
    ...
    <div>
      ...
      <div className="font-mono text-sm bg-terminal p-4 rounded-lg border border-border space-y-1">
        <div className="text-muted">Byte 1: <span className="text-emerald-400">110</span>xxxxx → 5 data slots</div>
        <div className="text-muted">Byte 2: <span className="text-emerald-400">10</span>xxxxxx → 6 data slots</div>
