...
<Step title="6. Making Relative Positions Easy">
  ...
  <Description>
    Since the rotation matrix depends only on k (the offset), "k steps ahead" applies the same linear transformation regardless of starting position. This could help the model learn consistent relative position patterns.
  </Description>
</Step>
