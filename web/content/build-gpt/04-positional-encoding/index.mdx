...
<Step title="2. Attempt 2: Scaling to [0, 1]">
  ...
  <div className="my-4 p-4 bg-terminal rounded-lg border border-border font-mono text-sm">
...
<Step title="5. Finding the Function">
  ...
  <Description>
    Applying this to our multi-frequency idea, each dimension gets its own sine wave cycling at a different frequency. The animation below shows how each dimension evolves across positions.
  </Description>
...
<Step title="6. Making Relative Positions Easy">
  ...
  <div className="my-4 p-4 bg-terminal rounded-lg border border-border">
  ...
  <div className="my-4 p-4 bg-terminal rounded-lg border border-border text-center">
  ...
  <div className="my-4 p-4 bg-terminal rounded-lg border border-border space-y-2">
    <div className="font-mono text-sm text-center">
      <span className="text-accent-4">sin(ω(pos + k))</span>
      <span className="text-muted"> = </span>
      <span className="text-accent-2">cos(ω·k)</span>
      <span className="text-muted"> · </span>
      <span className="text-accent-1">sin(ω·pos)</span>
      <span className="text-muted"> + </span>
      <span className="text-accent-2">sin(ω·k)</span>
      <span className="text-muted"> · </span>
      <span className="text-accent-1">cos(ω·pos)</span>
    </div>
    <div className="font-mono text-sm text-center">
      <span className="text-accent-4">cos(ω(pos + k))</span>
      <span className="text-muted"> = </span>
      <span className="text-accent-2">cos(ω·k)</span>
      <span className="text-muted"> · </span>
      <span className="text-accent-1">cos(ω·pos)</span>
  ...
  <div className="my-6 p-5 bg-surface rounded-lg border border-border overflow-x-auto">
    <div className="flex items-center justify-center gap-3 font-mono text-sm">
      {/* Target Vector */}
      <div className="flex flex-col gap-1 p-2 border-l-2 border-r-2 border-accent-4/50 rounded shrink-0">
        <span className="text-accent-4 whitespace-nowrap">sin(ω(pos+k))</span>
        <span className="text-accent-4 whitespace-nowrap">cos(ω(pos+k))</span>
      </div>
      
      <span className="text-muted shrink-0">=</span>

      {/* Rotation Matrix */}
      <div className="flex flex-col gap-1 p-2 border-l-2 border-r-2 border-accent-2/50 rounded bg-terminal shrink-0">
        <div className="flex gap-4">
          <span className="min-w-[70px] text-center text-accent-2 whitespace-nowrap">cos(ω·k)</span>
          <span className="min-w-[70px] text-center text-accent-2 whitespace-nowrap">sin(ω·k)</span>
        </div>
        <div className="flex gap-4">
          <span className="min-w-[70px] text-center text-accent-2 whitespace-nowrap">-sin(ω·k)</span>
          <span className="min-w-[70px] text-center text-accent-2 whitespace-nowrap">cos(ω·k)</span>
      ...
      {/* Current Vector */}
      <div className="flex flex-col gap-1 p-2 border-l-2 border-r-2 border-accent-1/50 rounded shrink-0">
        <span className="text-accent-1 whitespace-nowrap">sin(ω·pos)</span>
        <span className="text-accent-1 whitespace-nowrap">cos(ω·pos)</span>
      </div>
    </div>
  </div>
...
<Step title="7. Building the Formula">
  ...
  <Description>
    Now we need to choose the actual frequencies. We need a fastest frequency to distinguish neighboring positions, the way the ones digit in decimal distinguishes consecutive numbers, and a slowest frequency that doesn't repeat within our context window.
  </Description>
  ...
  <Callout type="success" title="Summary">
    ...
    * **Addition** combines position and meaning while preserving `d_model` dimensionality, avoiding extra parameters
  </Callout>
