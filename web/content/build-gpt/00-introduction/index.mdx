...
<Step title="What You Will Build">
  ...
  <Description>
    Throughout the course, you'll implement what you learn through coding challenges at the end of each chapter. Most challenges run directly in the built‑in editor and give feedback immediately. For the capstone project, you'll work locally with GPU support, and our <a href="/setup" className="underline underline-offset-2 hover:text-primary">CLI tool</a> helps you test components as you go.
  </Description>
