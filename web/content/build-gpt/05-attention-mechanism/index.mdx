  ...
  <div className="my-6 flex justify-center overflow-x-auto">
    <div className="inline-block">
      <div className="flex">
        ...
        <div className="text-xs text-muted mb-2 text-center" style={{ width: '224px' }}>Key</div>
      </div>
      <div className="flex">
        <div className="w-16"></div>
        <div className="w-14"></div>
        <div className="flex">
          {['The', 'bright', 'student', 'reads'].map((token, i) => (
            <div key={i} className="w-14 h-6 flex items-center justify-center text-xs text-muted font-mono">{token}</div>
          ))}
        </div>
      </div>
      <div className="flex">
        <div className="flex flex-col justify-center w-16">
          <div className="text-xs text-muted text-right pr-2">Query</div>
        </div>
        <div className="flex flex-col">
          {['The', 'bright', 'student', 'reads'].map((token, i) => (
            <div key={i} className="w-14 h-12 flex items-center justify-end pr-2 text-xs text-muted font-mono">{token}</div>
          ))}
        </div>
      ...
      <div className="flex">
        <div className="w-16"></div>
        <div className="w-14"></div>
        <div className="text-xs text-muted mt-2 text-center" style={{ width: '224px' }}>Higher scores = stronger relevance</div>
      </div>
    </div>
  </div>
</Step>
