...
<Step title="1. The Core Intuition: Tokenization is Compression">
  ...
  <div className="my-4 space-y-2">
    <div className="flex items-center gap-3 p-3 bg-surface rounded-lg border border-border">
      <span className="font-mono text-muted">t + h</span>
    ...
    <div className="flex items-center gap-3 p-3 bg-surface rounded-lg border border-border">
      <span className="font-mono text-muted">th + e</span>
      <span className="text-muted">→</span>
    ...
    <div className="flex items-center gap-3 p-3 bg-surface rounded-lg border border-border">
      <span className="font-mono text-muted">in + g</span>
      <span className="text-muted">→</span>
...
<Step title="2. The Algorithm: A Visual Walkthrough">
  ...
  <div className="my-4 p-4 bg-surface rounded-lg border border-border">
    <div className="text-sm text-secondary mb-3">Adjacent pairs in our sequence (same color = same pair type):</div>
  ...
  <div className="my-4 p-4 bg-surface rounded-lg border border-border">
    <div className="text-sm font-medium text-primary mb-3">After Merge #1: (a, a) → Z</div>
  ...
  <div className="my-4 p-4 bg-surface rounded-lg border border-border">
    <div className="text-sm font-medium text-primary mb-3">After Merge #2: (a, b) → Y</div>
    <div className="flex flex-wrap gap-2">
      <div className="w-10 h-10 flex items-center justify-center rounded-lg bg-emerald-500 text-white font-mono font-bold">Z</div>
  ...
  <div className="my-4 p-4 bg-surface rounded-lg border border-border">
    <div className="space-y-3">
      <div className="flex items-start gap-3">
        <div className="w-6 h-6 rounded-full bg-zinc-800 flex items-center justify-center text-xs font-bold text-secondary shrink-0 mt-0.5">1</div>
        <div>
          <span className="font-semibold text-primary">get_stats</span>
          <span className="text-secondary"> counts how often each adjacent pair appears</span>
        </div>
      </div>
      <div className="flex items-start gap-3">
        <div className="w-6 h-6 rounded-full bg-zinc-800 flex items-center justify-center text-xs font-bold text-secondary shrink-0 mt-0.5">2</div>
        <div>
          <span className="font-semibold text-primary">merge</span>
          <span className="text-secondary"> replaces all occurrences of a pair with a new token</span>
        </div>
      </div>
      <div className="flex items-start gap-3">
        <div className="w-6 h-6 rounded-full bg-zinc-800 flex items-center justify-center text-xs font-bold text-secondary shrink-0 mt-0.5">3</div>
        <div>
          <span className="font-semibold text-primary">train_bpe</span>
          <span className="text-secondary"> is the main loop that calls the above until we reach target vocab size</span>
        </div>
      </div>
    </div>
  </div>
...
<Step title="4. Regex Pre-splitting">
  ...
  <div className="my-4 p-4 bg-surface rounded-lg border border-border">
    <div className="text-sm font-medium text-primary mb-2">The Problem</div>
  ...
  <div className="my-4 p-4 bg-surface rounded-lg border border-border">
    <div className="text-sm font-medium text-primary mb-2">The Solution</div>
...
<Step title="5. Encoding & Decoding">
  ...
  <div className="my-4 p-4 bg-surface rounded-lg border border-border">
    <div className="text-sm font-medium text-primary mb-3">The Vocabulary: Token ID → Bytes</div>
...
```
  ...
  <div className="my-4 p-4 bg-surface rounded-lg border border-border">
    <div className="text-sm font-medium text-primary mb-3">Decoding [258, 99] back to text</div>
...
```
  ...
  <div className="my-4 p-4 bg-surface rounded-lg border border-border">
    <div className="text-sm font-medium text-primary mb-3">Encoding "aaab" with merges: (97,97)→256, (256,97)→257</div>
    <div className="space-y-3 font-mono text-sm">
      <div className="flex items-center gap-3">
