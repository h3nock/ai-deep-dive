...
<Step title="3. UTF-8: Variable-Width Encoding">
  ...
  <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mt-6 mb-3">3.1 Byte Ranges by Character Type</h4>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 my-4">
    ...
    <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700">
      ...
      <div className="text-xs text-slate-500 mt-2">é, ñ, Ω, Д</div>
    ...
    <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700">
      ...
      <div className="text-xs text-slate-500 mt-2">中, 日, ㄱ, ሀ</div>
    ...
    <div className="p-4 rounded-lg bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700">
      ...
      <div className="text-xs text-slate-500 mt-2">😊, 🚀, 𓀀</div>
  ...
  <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mt-6 mb-3">3.2 Fixed vs Variable Width: The Parsing Challenge</h4>
  ...
  <div className="my-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700">
    ...
    <div className="font-mono text-xs bg-white dark:bg-slate-900 p-3 rounded border border-slate-200 dark:border-slate-700 overflow-x-auto">
      <div className="text-slate-500 mb-2">Byte stream for "Aé中":</div>
  ...
  <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mt-6 mb-3">3.3 The UTF-8 Bit Patterns</h4>
    ...
    <table className="w-full text-sm border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden">
      ...
      <tbody className="font-mono text-xs">
        ...
        <tr className="border-t border-slate-100 dark:border-slate-800">
          ...
          <td className="py-3 px-4"><span className="text-slate-400">10</span>xxxxxx × 2</td>
        ...
        <tr className="border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/30">
          ...
          <td className="py-3 px-4"><span className="text-slate-400">10</span>xxxxxx × 3</td>
  ...
  <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mt-6 mb-3">3.4 Decoding a Byte Stream</h4>
      ...
      <div className="font-mono bg-white dark:bg-slate-900 p-3 rounded border border-slate-200 dark:border-slate-700">
        ...
        <div className="space-y-3">
          <div>
            ...
            <span className="text-slate-500 ml-2">→ starts with 0, so it's a 1-byte char</span>
          ...
          <div>
            ...
            <span className="text-slate-500 ml-2">→ starts with 110, so read 2 bytes total</span>
          </div>
          <div className="pl-4">
            ...
            <span className="text-slate-500 ml-2">→ continuation byte</span>
            <span className="ml-2 px-2 py-0.5 bg-slate-200 dark:bg-slate-700 rounded text-xs">C3 A9 = "é"</span>
          </div>
          <div>
            ...
            <span className="text-slate-500 ml-2">→ starts with 1110, so read 3 bytes total</span>
          </div>
          <div className="pl-4">
          ...
          <div className="pl-4">
            ...
            <span className="text-slate-500 ml-2">→ continuation byte</span>
            <span className="ml-2 px-2 py-0.5 bg-slate-200 dark:bg-slate-700 rounded text-xs">E4 B8 AD = "中"</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <h4 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mt-6 mb-3">3.5 Encoding a Character to Bytes</h4>
    ...
    <div className="space-y-4 text-sm">
      ...
      <div>
        ...
        <div className="font-mono bg-white dark:bg-slate-900 p-3 rounded border border-slate-200 dark:border-slate-700">
          ...
          <div className="text-slate-500 mb-1">We need to fit: 11101001 (pad to 11 bits → 00011101001)</div>
...
<Step title="5. Why Not Train on Raw Bytes?">
  ...
  >
    <div className="space-y-8">
      <div>
        <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100">The Byte-Level Problem: Drowning in Details</h4>
        ...
        <p className="my-4 text-lg italic text-slate-600 dark:text-slate-400 pl-4 border-l-2 border-slate-300 dark:border-slate-600">
      ...
      <div>
        <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100">The Word-Level Problem: The Vocabulary Explosion</h4>
        <p className="mt-3 text-base text-slate-700 dark:text-slate-300">
          So, why not go to the other extreme? Why not just give every word in the English language its own unique ID number?
        </p>
        <div className="my-4 font-mono text-base bg-slate-100 dark:bg-slate-800 p-4 rounded-lg border border-slate-200 dark:border-slate-700">
          <div className="text-slate-800 dark:text-slate-200">"Apple" = 101</div>
          <div className="text-slate-800 dark:text-slate-200">"Banana" = 102</div>
          <div className="text-slate-800 dark:text-slate-200">"ChatGPT" = 103</div>
        </div>
        <p className="text-base text-slate-700 dark:text-slate-300">
          This solves the length problem (sequences become very short), but it creates a <strong>Vocabulary Problem</strong>:
        </p>
        <ul className="list-disc pl-5 mt-4 space-y-3 text-base text-slate-700 dark:text-slate-300">
      ...
      <div>
        <h4 className="text-lg font-bold text-slate-900 dark:text-slate-100">The Middle Ground: Sub-word Tokenization</h4>
        <p className="mt-3 text-base text-slate-700 dark:text-slate-300">
        ...
        <ul className="list-disc pl-5 mt-4 space-y-2 text-base text-slate-700 dark:text-slate-300">
...
<Step title="6. Next: Tokenization">
  ...
  <div className="my-4 p-4 bg-slate-50 dark:bg-slate-800/40 rounded-lg border border-slate-200 dark:border-slate-700">
    ...
    <div className="space-y-2 font-mono text-sm">
      <div className="flex items-center gap-2">
        <span className="text-slate-600 dark:text-slate-400">"Hello" →</span>
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <span className="text-slate-600 dark:text-slate-400">"Unbelievable" →</span>
