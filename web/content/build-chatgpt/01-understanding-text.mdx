...
challenges:
  ...
  - id: "byte-inspector"
    ...
    description: "Write a function `inspect_bytes(byte_list)` that takes a list of integers (0-255) representing bytes and returns a string description. If the byte is printable ASCII (32-126), show the character. Otherwise, show 'Hex: XX'."
    initialCode: |
      def inspect_bytes(byte_list):
          # Your code here
          pass
    difficulty: "Medium"
    arguments:
    ...
    defaultTestCases:
      ...
      - id: "case2"
        inputs:
          byte_list: "[0, 255, 65]"
        expected: '"Hex: 00 Hex: FF A"'
    executionSnippet: |
      print(inspect_bytes(byte_list))
---
