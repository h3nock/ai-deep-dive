...
<Step title="1. Why Position Matters">
  ...
  <div className="my-4 p-4 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
    <div className="flex items-start gap-3">
      ...
      <div>
        <div className="font-bold text-red-800 dark:text-red-300 mb-1">The Core Problem</div>
...
<Step title="2. First Attempt: Integer Indexing">
  ...
  <div className="my-4 p-5 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700">
    <div className="flex items-start gap-4">
      <div className="p-3 bg-red-100 dark:bg-red-900/30 rounded-lg text-2xl shrink-0">💥</div>
      <div>
        <div className="font-bold text-slate-800 dark:text-slate-200 mb-2">Problem 1: Magnitude Explosion</div>
        ...
        <div className="p-3 bg-white dark:bg-slate-900 rounded border border-slate-200 dark:border-slate-700 font-mono text-sm">
          <div className="space-y-1">
            <div className="text-slate-600 dark:text-slate-400">Position 0: embedding + [0, 0, ...] → <span className="text-emerald-600">✓ Fine</span></div>
            <div className="text-slate-600 dark:text-slate-400">Position 100: embedding + [100, 100, ...] → <span className="text-red-600">💥 Values ~100</span></div>
            <div className="text-slate-600 dark:text-slate-400">Position 1000: embedding + [1000, 1000, ...] → <span className="text-red-600">💥 Values ~1000</span></div>
          </div>
        </div>
        <div className="mt-3 text-sm text-slate-600 dark:text-slate-400">
          Words at position 1000 would have vectors 1000× larger than words at position 0. The neural network's math breaks down completely—later positions dominate all calculations.
        </div>
      </div>
    </div>
  </div>
  ...
  <div className="my-4 p-5 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700">
    <div className="flex items-start gap-4">
      <div className="p-3 bg-red-100 dark:bg-red-900/30 rounded-lg text-2xl shrink-0">📏</div>
      <div>
        <div className="font-bold text-slate-800 dark:text-slate-200 mb-2">Problem 2: Unbounded Range</div>
        <div className="text-sm text-slate-600 dark:text-slate-400 mb-3">
  ...
  <div className="my-4 p-5 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700">
    <div className="flex items-start gap-4">
      <div className="p-3 bg-red-100 dark:bg-red-900/30 rounded-lg text-2xl shrink-0">🔢</div>
      <div>
        <div className="font-bold text-slate-800 dark:text-slate-200 mb-2">Problem 3: No Relative Information</div>
        <div className="text-sm text-slate-600 dark:text-slate-400 mb-3">
  ...
  <Callout type="warning" title="Verdict: Integer Indexing">
    ❌ **Failed.** Raw integers create magnitude problems, don't generalize to new lengths, and destroy the notion of relative distance.
  </Callout>
</Step>
...
<Step title="3. Second Attempt: 0-1 Normalization">
  ...
  <div className="my-4 p-5 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700">
    <div className="flex items-start gap-4">
      <div className="p-3 bg-red-100 dark:bg-red-900/30 rounded-lg text-2xl shrink-0">📐</div>
      <div>
        <div className="font-bold text-slate-800 dark:text-slate-200 mb-2">Problem 1: Resolution Depends on Sequence Length</div>
        <div className="text-sm text-slate-600 dark:text-slate-400 mb-3">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <div className="font-mono text-xs text-slate-600 dark:text-slate-400">
                ...
                pos 1 → 0.1<br/>
                pos 2 → 0.2<br/>
                <span className="text-amber-600">Step = 0.1</span>
              </div>
            </div>
            <div>
              ...
              <div className="font-mono text-xs text-slate-600 dark:text-slate-400">
                ...
                pos 1 → 0.001<br/>
                pos 2 → 0.002<br/>
                <span className="text-amber-600">Step = 0.001</span>
              </div>
            </div>
          </div>
        </div>
  ...
  <div className="my-4 p-5 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700">
    <div className="flex items-start gap-4">
      <div className="p-3 bg-red-100 dark:bg-red-900/30 rounded-lg text-2xl shrink-0">🔮</div>
      <div>
        <div className="font-bold text-slate-800 dark:text-slate-200 mb-2">Problem 2: Requires Knowing Sequence Length in Advance</div>
        <div className="text-sm text-slate-600 dark:text-slate-400 mb-3">
  ...
  <div className="my-4 p-5 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700">
    <div className="flex items-start gap-4">
      <div className="p-3 bg-red-100 dark:bg-red-900/30 rounded-lg text-2xl shrink-0">🎯</div>
      <div>
        <div className="font-bold text-slate-800 dark:text-slate-200 mb-2">Problem 3: Low Precision for Long Sequences</div>
        <div className="text-sm text-slate-600 dark:text-slate-400 mb-3">
        ...
        <div className="p-3 bg-white dark:bg-slate-900 rounded border border-slate-200 dark:border-slate-700 font-mono text-sm">
          <div className="space-y-1">
            ...
            <div className="text-red-600 dark:text-red-400">Difference: 0.0001 → Nearly indistinguishable!</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <Callout type="warning" title="Verdict: 0-1 Normalization">
    ❌ **Failed.** Resolution varies with length, requires future knowledge, and loses precision for long sequences.
  </Callout>
</Step>
...
<Step title="4. What We Actually Need">
  ...
  <div className="my-6 space-y-4">
    <div className="flex items-start gap-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700">
      <div className="w-10 h-10 rounded-full bg-emerald-100 dark:bg-emerald-900/50 flex items-center justify-center text-emerald-600 dark:text-emerald-400 font-bold shrink-0">1</div>
      <div>
    ...
    <div className="flex items-start gap-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700">
      <div className="w-10 h-10 rounded-full bg-emerald-100 dark:bg-emerald-900/50 flex items-center justify-center text-emerald-600 dark:text-emerald-400 font-bold shrink-0">2</div>
      <div>
    ...
    <div className="flex items-start gap-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700">
      <div className="w-10 h-10 rounded-full bg-emerald-100 dark:bg-emerald-900/50 flex items-center justify-center text-emerald-600 dark:text-emerald-400 font-bold shrink-0">3</div>
      <div>
    ...
    <div className="flex items-start gap-4 p-4 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700">
      <div className="w-10 h-10 rounded-full bg-emerald-100 dark:bg-emerald-900/50 flex items-center justify-center text-emerald-600 dark:text-emerald-400 font-bold shrink-0">5</div>
      <div>
...
<Step title="5. The Elegant Solution: Sinusoidal Encoding">
  ...
  <div className="my-4 space-y-4">
    <div className="p-4 bg-violet-50 dark:bg-violet-900/20 rounded-lg border border-violet-200 dark:border-violet-800">
      <div className="font-bold text-violet-800 dark:text-violet-300 mb-2">$pos$ = Position in the sequence</div>
    ...
    <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
      <div className="font-bold text-amber-800 dark:text-amber-300 mb-2">$i$ = Dimension index (0 to d_model/2)</div>
    ...
    <div className="p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg border border-emerald-200 dark:border-emerald-800">
      <div className="font-bold text-emerald-800 dark:text-emerald-300 mb-2">$10000^{2i/d_{model}}$ = The wavelength scaler</div>
      <div className="text-sm text-emerald-700 dark:text-emerald-300">
    ...
    <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
      <div className="font-bold text-blue-800 dark:text-blue-300 mb-2">$\sin$ and $\cos$ alternating</div>
      <div className="text-sm text-blue-700 dark:text-blue-300">
...
<Step title="6. Visualizing the Waves">
  ...
  <div className="my-6 p-6 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700">
    ...
    <div className="flex justify-center">
      <svg viewBox="0 0 500 300" className="w-full max-w-lg">
        ...
        {/* X-axis label */}
        <text x="250" y="275" textAnchor="middle" className="fill-slate-600 dark:fill-slate-400 text-xs">Position →</text>
        ...
        <g transform="translate(280, 20)">
          ...
          <line x1="15" y1="20" x2="45" y2="20" className="stroke-violet-500" strokeWidth="2"/>
          <text x="55" y="24" className="fill-slate-600 dark:fill-slate-400 text-[10px]">Dim 0 (fast)</text>
          <line x1="15" y1="40" x2="45" y2="40" className="stroke-amber-500" strokeWidth="2"/>
          <text x="55" y="44" className="fill-slate-600 dark:fill-slate-400 text-[10px]">Dim 128 (medium)</text>
          <line x1="15" y1="60" x2="45" y2="60" className="stroke-emerald-500" strokeWidth="2"/>
  ...
  <div className="my-4 space-y-3">
    <div className="flex items-center gap-3 p-3 bg-violet-50 dark:bg-violet-900/20 rounded-lg border border-violet-200 dark:border-violet-800">
      <span className="font-bold text-violet-700 dark:text-violet-300 w-36 shrink-0">Dimension 0:</span>
      <span className="text-sm text-violet-600 dark:text-violet-300">Completes a full cycle every ~6 positions (like a second hand)</span>
    </div>
    <div className="flex items-center gap-3 p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
      <span className="font-bold text-amber-700 dark:text-amber-300 w-36 shrink-0">Dimension 128:</span>
      <span className="text-sm text-amber-600 dark:text-amber-300">Completes a cycle every ~100 positions (like a minute hand)</span>
    </div>
    <div className="flex items-center gap-3 p-3 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg border border-emerald-200 dark:border-emerald-800">
      <span className="font-bold text-emerald-700 dark:text-emerald-300 w-36 shrink-0">Dimension 384:</span>
      <span className="text-sm text-emerald-600 dark:text-emerald-300">Completes a cycle every ~10,000 positions (like an hour hand)</span>
    </div>
  </div>
...
<Step title="7. Why Sinusoids Are Brilliant">
  ...
  <div className="my-6 space-y-4">
    <div className="flex items-start gap-4 p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg border border-emerald-200 dark:border-emerald-800">
      <span className="text-2xl">✅</span>
      <div>
        <div className="font-bold text-emerald-800 dark:text-emerald-300">Bounded Values</div>
    ...
    <div className="flex items-start gap-4 p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg border border-emerald-200 dark:border-emerald-800">
      <span className="text-2xl">✅</span>
      <div>
        <div className="font-bold text-emerald-800 dark:text-emerald-300">Unique for Each Position</div>
        <div className="text-sm text-emerald-700 dark:text-emerald-300 mt-1">
    ...
    <div className="flex items-start gap-4 p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg border border-emerald-200 dark:border-emerald-800">
      <span className="text-2xl">✅</span>
      <div>
        <div className="font-bold text-emerald-800 dark:text-emerald-300">Consistent Relative Distances</div>
        <div className="text-sm text-emerald-700 dark:text-emerald-300 mt-1">
    ...
    <div className="flex items-start gap-4 p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg border border-emerald-200 dark:border-emerald-800">
      <span className="text-2xl">✅</span>
      <div>
        <div className="font-bold text-emerald-800 dark:text-emerald-300">Generalizes to Unseen Lengths</div>
        <div className="text-sm text-emerald-700 dark:text-emerald-300 mt-1">
    ...
    <div className="flex items-start gap-4 p-4 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg border border-emerald-200 dark:border-emerald-800">
      <span className="text-2xl">✅</span>
      <div>
        <div className="font-bold text-emerald-800 dark:text-emerald-300">Deterministic (No Learning Required)</div>
        <div className="text-sm text-emerald-700 dark:text-emerald-300 mt-1">
...
<Step title="8. Combining Position with Meaning">
  ...
  <div className="my-4 space-y-3">
    <div className="flex items-center gap-3 p-3 bg-red-50 dark:bg-red-900/20 rounded-lg border border-red-200 dark:border-red-800">
      <span className="font-bold text-red-700 dark:text-red-400 w-36 shrink-0">Embedding (Color):</span>
      <span className="text-sm text-slate-700 dark:text-slate-300">"Apple" is <span className="font-semibold text-red-600 dark:text-red-400">Red</span></span>
    </div>
    <div className="flex items-center gap-3 p-3 bg-slate-100 dark:bg-slate-800/60 rounded-lg border border-slate-200 dark:border-slate-700">
      <span className="font-bold text-slate-700 dark:text-slate-400 w-36 shrink-0">Position (Texture):</span>
  ...
  <Description>
    Neural networks work the same way. With enough training, the model learns to "un-mix" the combined signal. It recognizes the semantic features ("Red" → fruit) and the positional features ("Smooth" → early in sentence) as separate patterns.
  </Description>
    ...
    <div className="space-y-6">
      <div className="relative flex gap-4">
        ...
        <div className="flex-1 pt-2">
          ...
          <div className="font-mono text-sm text-slate-600 dark:text-slate-400 mt-1">
            "Alice gave Bob" → [15496, 2921, 9352]
          </div>
        </div>
      </div>

      <div className="relative flex gap-4">
        <div className="w-12 h-12 rounded-full bg-blue-100 dark:bg-blue-900/40 border-2 border-blue-400 dark:border-blue-600 flex items-center justify-center text-blue-700 dark:text-blue-300 font-bold z-0">2</div>
        <div className="flex-1 pt-2">
          ...
          <div className="font-mono text-xs text-slate-500 mt-2">
            embed[15496] → [0.12, -0.45, 0.78, ...] (768 values)
          </div>
        </div>
      </div>
      ...
      <div className="relative flex gap-4">
        ...
        <div className="flex-1 pt-2">
          ...
          <div className="font-mono text-xs text-slate-500 mt-2">
            PE(0) → [0.00, 1.00, 0.00, 1.00, ...] (768 values)<br/>
            PE(1) → [0.84, 0.54, 0.01, 1.00, ...]<br/>
      ...
      <div className="relative flex gap-4">
        ...
        <div className="flex-1 pt-2">
          ...
          <div className="font-mono text-xs text-emerald-600 dark:text-emerald-400 mt-2">
            input[0] = embed("Alice") + PE(0) → "Alice at position 0"<br/>
            input[1] = embed("gave") + PE(1) → "gave at position 1"<br/>
            input[2] = embed("Bob") + PE(2) → "Bob at position 2"
          </div>
        </div>
      </div>

      <div className="relative flex gap-4">
        <div className="w-12 h-12 rounded-full bg-violet-100 dark:bg-violet-900/40 border-2 border-violet-400 dark:border-violet-600 flex items-center justify-center text-violet-700 dark:text-violet-300 font-bold z-0">5</div>
        <div className="flex-1 pt-2">
...
<Step title="10. Learned vs. Sinusoidal: A Brief Note">
  ...
  <div className="my-6 grid grid-cols-1 md:grid-cols-2 gap-4">
    <div className="p-5 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
      <div className="flex items-center gap-3 mb-3">
        <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900/50 flex items-center justify-center text-blue-600 dark:text-blue-400 text-xl">📐</div>
        <span className="font-bold text-lg text-blue-800 dark:text-blue-300">Sinusoidal</span>
      </div>
      <div className="text-sm text-blue-700 dark:text-blue-300 space-y-2">
        <div>✅ No parameters to learn</div>
        <div>✅ Generalizes to any length</div>
        <div>✅ Built-in relative distance</div>
        <div>⚠️ Fixed pattern (not task-specific)</div>
      </div>
    </div>

    <div className="p-5 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg border border-emerald-200 dark:border-emerald-800">
      <div className="flex items-center gap-3 mb-3">
        <div className="w-10 h-10 rounded-full bg-emerald-100 dark:bg-emerald-900/50 flex items-center justify-center text-emerald-600 dark:text-emerald-400 text-xl">🧠</div>
        <span className="font-bold text-lg text-emerald-800 dark:text-emerald-300">Learned</span>
      </div>
      <div className="text-sm text-emerald-700 dark:text-emerald-300 space-y-2">
        <div>✅ Can adapt to the task</div>
        <div>✅ Potentially better performance</div>
        <div>⚠️ Limited to trained length</div>
        <div>⚠️ More parameters</div>
      </div>
    </div>
  </div>
...
<Step title="11. Summary">
  <Callout type="success" title="What We Learned">
    * **Position matters**: "Alice gave Bob" ≠ "Bob gave Alice"
  ...
  <div className="my-4 p-4 bg-slate-100 dark:bg-slate-800/60 rounded-lg border border-slate-200 dark:border-slate-700">
    <div className="text-center font-mono text-sm text-slate-800 dark:text-slate-200">
      Text → Bytes → Tokens → Embeddings → <span className="text-emerald-600 dark:text-emerald-400 font-bold">+ Positional Encoding</span> → Input Vectors
    </div>
  </div>
