...
<Step title="6. The Missing Piece: Word Order">
  ...
  <Description>
    We need a way to stamp each vector with its position. That's exactly what we'll solve next.
  </Description>
</Step>


<Step title="7. The Missing Piece: Word Order">
  <Description>
    We have solved the meaning problem. We can translate "King" into a rich vector that captures its essence.
  </Description>

  <Description>
    But here's a critical gap. Look at these two sentences:
  </Description>
  ...
  <div className="my-6 grid grid-cols-1 md:grid-cols-2 gap-4">
    <div className="p-5 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
      <div className="flex items-center gap-3 mb-3">
        <span className="text-2xl">👉</span>
        <span className="font-bold text-lg text-blue-800 dark:text-blue-300">"Alice gave Bob a book"</span>
      </div>
    ...
    <div className="p-5 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg border border-emerald-200 dark:border-emerald-800">
      <div className="flex items-center gap-3 mb-3">
        <span className="text-2xl">👈</span>
        <span className="font-bold text-lg text-emerald-800 dark:text-emerald-300">"Bob gave Alice a book"</span>
      </div>
  ...
  <Description>
    The exact same words. The exact same embeddings. But completely different meanings! The only difference is **position**.
  </Description>

  <Description>
    Traditional language models (like RNNs) read words one by one, left to right, so order is built in. But this sequential approach is painfully slow—you can't process word #5 until you've finished words #1 through #4.
  </Description>
  ...
  <div className="my-4 p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
    <div className="flex items-start gap-3">
      <span className="text-2xl">🤔</span>
      <div>
        <div className="font-bold text-amber-800 dark:text-amber-300 mb-1">The Challenge</div>
        <div className="text-sm text-amber-700 dark:text-amber-300">
          We need to somehow inject position information into our embeddings. But how? Simple solutions like "just use the position number" have serious problems. The next chapter dives deep into this puzzle.
        </div>
      </div>
    </div>
  </div>
...
<Step title="8. Summary">
  <Callout type="success" title="What We Learned">
    ...
    * **Parallel processing** is fast but loses word order—we've identified this as a critical missing piece
  </Callout>

  <Description>
    We now have a powerful way to represent **what** each token means. The embedding for "King" captures royalty and masculinity. The embedding for "Apple" captures fruit-ness. Similar concepts cluster together in a high-dimensional space where meaning becomes geometry.
  </Description>

  <Description>
    But we've hit a wall. Our embeddings don't know **where** they are. "Alice gave Bob" and "Bob gave Alice" produce identical embedding sequences—yet mean completely different things.
  </Description>

  <Description>
    In the next chapter, we'll tackle **Positional Encoding**: how to stamp each vector with its location in the sentence. We'll explore why simple solutions fail and arrive at an elegant mathematical trick that modern Transformers use to understand word order.
  </Description>
</Step>
