...
<Step title="5. Implementation: The Embedding Matrix">
  ...
  <Description>
    Training is the process where the model discovers what each dimension should represent. We show it many sentences, and it gradually adjusts the coordinates based on what it sees.
  </Description>
