...
<Step title="1. The Problem with Raw Token IDs">
  ...
  <div className="my-4 p-4 bg-surface rounded-lg border border-border">
    <div className="text-sm font-semibold text-primary mb-2">The Core Problem</div>
...
<Step title="5. Implementation: The Embedding Matrix">
  ...
  <div className="my-4 p-4 bg-surface rounded-lg border border-border">
    <div className="text-sm font-medium text-primary mb-3">The Embedding Matrix Structure</div>
