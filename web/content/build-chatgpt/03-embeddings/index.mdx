...
<Step title="3. Visualizing the Meaning Space">
  ...
  <div className="my-6 p-6 bg-slate-50 dark:bg-slate-800/50 rounded-lg border border-slate-200 dark:border-slate-700">
    ...
    <div className="relative w-full max-w-md mx-auto aspect-square">
      ...
      {/* Axis Labels */}
      <div className="absolute right-2 top-1/2 transform -translate-y-6 text-xs font-medium text-slate-500 dark:text-slate-400">Gender (+)</div>
      <div className="absolute left-2 top-1/2 transform translate-y-6 text-xs font-medium text-slate-500 dark:text-slate-400">Gender (-)</div>
      ...
      <div className="absolute top-[45%] right-[10%] flex flex-col items-center">
        <span className="text-2xl">🧔</span>
