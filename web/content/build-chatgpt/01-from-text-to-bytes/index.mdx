  ...
  <div className="my-6 space-y-6">
    ...
    <div>
      ...
      <div className="text-sm text-secondary space-y-3">
        ...
        <p>The emoji's code point (128,075) requires 4-byte encoding. Using the same process we showed for "é", the bits get distributed across four bytes following the `11110xxx 10xxxxxx 10xxxxxx 10xxxxxx` template, producing: 240 (0xF0), 159 (0x9F), 145 (0x91), 139 (0x8B).</p>
      </div>
    </div>
