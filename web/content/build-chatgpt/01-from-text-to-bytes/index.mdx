...
<Step title="3. UTF-8: Variable-Width Encoding">
  ...
  <h4 className="text-lg font-semibold text-primary mt-6 mb-3">3.1 Byte Ranges by Character Type</h4>
  ...
  <h4 className="text-lg font-semibold text-primary mt-6 mb-3">3.2 Fixed vs Variable Width: The Parsing Challenge</h4>
  ...
  <h4 className="text-lg font-semibold text-primary mt-6 mb-3">3.3 The UTF-8 Bit Patterns</h4>
  ...
  <div className="my-6 p-4 bg-[#121212] rounded-lg border border-zinc-800">
    <h5 className="text-sm font-medium text-primary mb-2">Key Insight</h5>
  ...
  <h4 className="text-lg font-semibold text-primary mt-6 mb-3">3.4 Decoding a Byte Stream</h4>
  ...
  <div className="my-6 font-mono text-sm bg-[#121212] p-4 rounded-lg border border-zinc-800">
    <div className="text-muted mb-3">Bytes: 41 C3 A9 E4 B8 AD</div>
    <div className="space-y-3">
      <div>
        <span className="text-secondary">Byte 1:</span> <span className="font-semibold">41</span> = <span className="text-emerald-400">0</span>1000001
        <span className="text-muted ml-2">→ starts with 0, so it's a 1-byte char</span>
        <span className="ml-2 px-2 py-0.5 bg-zinc-800 rounded text-xs">= "A"</span>
      </div>
      <div>
        <span className="text-secondary">Byte 2:</span> <span className="font-semibold">C3</span> = <span className="text-emerald-400">110</span>00011
        <span className="text-muted ml-2">→ starts with 110, so read 2 bytes total</span>
      </div>
      <div className="pl-4">
        <span className="text-secondary">Byte 3:</span> <span className="font-semibold">A9</span> = <span className="text-muted">10</span>101001
        <span className="text-muted ml-2">→ continuation byte</span>
        <span className="ml-2 px-2 py-0.5 bg-zinc-800 rounded text-xs">C3 A9 = "é"</span>
      </div>
      <div>
        <span className="text-secondary">Byte 4:</span> <span className="font-semibold">E4</span> = <span className="text-emerald-400">1110</span>0100
        <span className="text-muted ml-2">→ starts with 1110, so read 3 bytes total</span>
      </div>
      <div className="pl-4">
        <span className="text-secondary">Byte 5:</span> <span className="font-semibold">B8</span> = <span className="text-muted">10</span>111000
        <span className="text-muted ml-2">→ continuation byte</span>
      </div>
      <div className="pl-4">
        <span className="text-secondary">Byte 6:</span> <span className="font-semibold">AD</span> = <span className="text-muted">10</span>101101
        <span className="text-muted ml-2">→ continuation byte</span>
        <span className="ml-2 px-2 py-0.5 bg-zinc-800 rounded text-xs">E4 B8 AD = "中"</span>
      </div>
    </div>
  </div>
  ...
  <h4 className="text-lg font-semibold text-primary mt-6 mb-3">3.5 Encoding a Character to Bytes</h4>
  ...
  <div className="my-6 space-y-4">
    ...
    <div>
      ...
      <div className="font-mono text-sm bg-[#121212] p-4 rounded-lg border border-zinc-800">
        ...
        <div className="text-muted mb-1">We need to fit: 11101001 (pad to 11 bits → 00011101001)</div>
    ...
    <div>
      ...
      <div className="font-mono text-sm bg-[#121212] p-4 rounded-lg border border-zinc-800">
        <div>Byte 1: <span className="text-muted">110</span><span className="text-emerald-400">00011</span> = 11000011 = <span className="font-semibold">195</span></div>
        <div>Byte 2: <span className="text-muted">10</span><span className="text-emerald-400">101001</span> = 10101001 = <span className="font-semibold">169</span></div>
      </div>
    </div>
    <div>
      <h5 className="text-sm font-medium text-primary mb-2">Result</h5>
      <div className="font-mono text-sm bg-[#121212] p-4 rounded-lg border border-zinc-800">
        "é" → <span className="font-semibold">[195, 169]</span>
      </div>
    </div>
  </div>
</Step>
  ...
  <div className="my-6 space-y-6">
    ...
    <div>
      ...
      <div className="text-sm text-secondary space-y-3">
        ...
        <p>The emoji's code point (128,075) requires 4-byte encoding. Using the same process we showed for "é", the bits get distributed across four bytes following the `11110xxx 10xxxxxx 10xxxxxx 10xxxxxx` template, producing: 240, 159, 145, 139.</p>
      </div>
    </div>
...
<Step title="5. Why Not Train on Raw Bytes?">
  ...
  <Description>
    A very natural question arises: **Why don't we just feed these raw bytes directly into the AI?**
  </Description>
  ...
  >
    <div className="space-y-8">
      <div>
        <h4 className="text-lg font-bold text-primary">The Byte-Level Problem: Drowning in Details</h4>
        ...
        <p className="my-4 text-lg italic text-secondary pl-4 border-l-2 border-border">
      ...
      <div>
        <h4 className="text-lg font-bold text-primary">The Word-Level Problem: The Vocabulary Explosion</h4>
        <p className="mt-3 text-base text-primary">
          So, why not go to the other extreme? Why not just give every word in the English language its own unique ID number?
        </p>
        <div className="my-4 font-mono text-base bg-[#121212] p-4 rounded-lg border border-zinc-800">
      ...
      <div>
        <h4 className="text-lg font-bold text-primary">The Middle Ground: Sub-word Tokenization</h4>
        <p className="mt-3 text-base text-primary">
