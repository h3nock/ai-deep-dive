  ...
  return (
    ...
    >
      <div
        ...
        [&>p_a]:text-primary [&>p_a]:underline [&>p_a]:underline-offset-4 [&>p_a]:decoration-zinc-700 hover:[&>p_a]:decoration-zinc-400 hover:[&>p_a]:text-primary [&>p_a]:transition-colors
